...
const buttonVariants = cva(
  'active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none disabled:opacity-50 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        default:
          'bg-red-500 text-white hover:bg-slate-800',
        ...
        navActive: 'font-bold text-lg text-white border-b-4 border-red-500 rounded-none focus:outline-2 focus:outline-white',
      },
      size: {
